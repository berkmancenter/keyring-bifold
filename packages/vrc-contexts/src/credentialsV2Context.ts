 ...
 *
 * Bundled verbatim (fetched 2026-07-08) so mobile and server can resolve the
 * VCDM 2.0 context offline: credo's built-in context cache only ships the
 * v1.1 credentials context, and mobile must never fetch contexts at runtime
 * (canonicalization would depend on the network and could be tampered with).
 */

export const CREDENTIALS_V2_CONTEXT_URL = 'https://www.w3.org/ns/credentials/v2'

export const CREDENTIALS_V2_CONTEXT_DOCUMENT = {
  "@context": {
    "@protected": true,
    "id": "@id",
    "type": "@type",
