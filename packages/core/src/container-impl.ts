...
export class MainContainer implements Container {
  ...
  public init(): Container {
    ...
    this._container.registerInstance(TOKENS.COMPONENT_CONTACT_DETAILS_FOOTER, () => null)
    this._container.registerInstance(TOKENS.COMPONENT_CONNECTION_ALERT, ConnectionAlert)
    this._container.registerInstance(TOKENS.COMPONENT_APP_GLOBAL_LISTENER, () => null)
